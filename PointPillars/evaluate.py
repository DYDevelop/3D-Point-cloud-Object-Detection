    ...
    for e_ind, eval_type in enumerate(['bbox_2d', 'bbox_bev', 'bbox_3d']):
        ...
        for cls in CLASSES:
            ...
            for difficulty in [0, 1, 2]:
                ...
                # mAP40
                sums_AP = 0
                for i in range(1, len(score_thresholds)):
                ...
                if eval_type == 'bbox_2d':
                    ...
                    mSimilarity = sums_similarity / 40 * 100
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', default='pillar_logs/checkpoints/epoch_120.pth', help='your checkpoint for kitti')
